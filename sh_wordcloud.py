...
file = open('./美团商家信息/上海商家.csv','r',encoding='utf-8')
...
backgroud=np.array(Image.open("sh.jpg")) #背景图片
mywordcloud=WordCloud(width=1200, height=1200,background_color="#C1FFC1", #背景颜色
                      margin=1,
