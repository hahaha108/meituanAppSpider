...
file = open('./美团商家信息/襄阳商家.csv','r',encoding='utf-8')
...
backgroud=np.array(Image.open("xy.jpg")) #背景图片
mywordcloud=WordCloud(width=1200, height=1200,background_color="#FFFF99", #背景颜色
                      margin=1,
