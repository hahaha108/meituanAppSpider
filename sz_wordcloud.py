...
file = open('./美团商家信息/深圳商家.csv','r',encoding='utf-8')
...
backgroud=np.array(Image.open("sz.jpg")) #背景图片
mywordcloud=WordCloud(width=1400, height=700,background_color="pink", #背景颜色
                      margin=1,
